...
export const databaseUrlSecret = createSecret(
  'database-url-secret',
  `${names.prefix}-database-url`,
);
export const betterAuthSecret = createSecret(
  'better-auth-secret',
  `${names.prefix}-better-auth-secret`,
);
export const googleClientSecret = createSecret(
  'google-client-secret',
  `${names.prefix}-google-client-secret`,
);
export const githubClientSecret = createSecret(
  'github-client-secret',
  `${names.prefix}-github-client-secret`,
);

export const betterAuthSecretVersion = new gcp.secretmanager.SecretVersion(
  'better-auth-secret-version',
  {
...
const runtimeSecretAccess = [
  ...
  {
    name: 'api-google-client-secret-access',
    secret: googleClientSecret,
    account: apiRuntimeAccount,
  },
  {
    name: 'api-github-client-secret-access',
    secret: githubClientSecret,
    account: apiRuntimeAccount,
  },
  {
    name: 'migration-database-url-access',
    secret: databaseUrlSecret,
    account: migrationRuntimeAccount,
  },
  {
    name: 'migration-better-auth-secret-access',
