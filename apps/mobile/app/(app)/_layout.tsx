...
export default function AppLayout() {
  return (
    <Stack>
      ...
      <Stack.Screen name="data/history/[metricKey]" options={{ headerShown: false }} />
      <Stack.Screen name="labs/import" options={{ headerShown: false }} />
      <Stack.Screen name="labs/import/[jobId]" options={{ headerShown: false }} />
      <Stack.Screen name="labs/import/[jobId]/result" options={{ headerShown: false }} />
      ...
      <Stack.Screen name="check-in/anchor-done" options={{ headerShown: false }} />
      <Stack.Screen name="check-in/go-deeper" options={{ headerShown: false }} />
      <Stack.Screen name="check-in/saved" options={{ headerShown: false }} />
      <Stack.Screen name="check-in/history" options={{ headerShown: false }} />
      <Stack.Screen name="check-in/[checkinId]" options={{ headerShown: false }} />
